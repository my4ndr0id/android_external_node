...
cleanup = function(pkgList) {
 for (i in pkgList){
   ...
   try{
     ...
     console.log("rmdirRSync : " + pkgList[i] + "Failed" + ex);
   }
 }
}
...
exports.modLoaderTests = runTest;
...
// runTest(function(){console.log("Done!!!")});
//-------------------------------------------Tests Executer--------------------------------------------------------------------------------
...
function testInvalidModuleDownload(callback){
  ...
  downloadInstanceSuccess.loadPackage("addNotValid", function () {
